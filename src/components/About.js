            ...
            <div className="about-container">
                <div className="description-container">
                    <div className="description-wrapper">
                        ...
                        <p>Hi, I'm David!</p>
                        <p>
                        I'm a Software Developer with a bachelor's degree in Mechatronics Engineering. Currently based in Toronto, ON. I love to code and work on interesting software development projects in my free time. I have a diverse set of experiences and technical skillsets that range from robotics, low-level software to full-stack web and app development.
                        </p>
                        </div>
